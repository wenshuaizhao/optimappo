...
class MujocoRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                """
                actions shape: num_threads*num_agents*action_dimension
                obs shape: num_threads*num_agents*obs_dimension
                rewards shape: num_threads*num_agents*1
                infos shape: tuple with length num_threads
                """
            ...
            if episode % self.log_interval == 0:
                ...
                if len(done_episodes_rewards) > 0:
                    ...
                    self.log_env({'train_episode_rewards': [aver_episode_rewards]}, total_num_steps=total_num_steps)
    ...
    ## Comment the following log_train out since we don't need to repeat the function,
    ## as we can directly use it from the base runner. 
