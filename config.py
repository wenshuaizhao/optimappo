...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["rmappo", "mappo", "rmappo_opt", "mappo_opt", "rmappo_clip",
                                                  "mappo_clip", "happo","hatrpo", "mappo_swish"])
    ...
    # added for mappo_opt
    parser.add_argument("--use_nonnegtive_opt", action='store_true', default=False)
    parser.add_argument("--use_adv_nml", action='store_false', default=True)
    parser.add_argument("--use_writter", action='store_false', default=True)
    parser.add_argument("--use_opt_clip", action='store_true', default=False)
    parser.add_argument("--use_q", action='store_true', default=False)
    parser.add_argument("--use_c", action='store_true', default=False)
    parser.add_argument("--wandb_tag", type=str, default='none')
    parser.add_argument("--leaky_rate", type=float, default=0.0, help="the play interval of each rendered image in saved video.")
